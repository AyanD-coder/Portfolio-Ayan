const projects = [
  {
    ...
    description:
      "Contributed to EmpTrakr as a Software Engineer at YoForex, helping deliver a production employee monitoring and HRMS platform now used by more than 30 registered companies across an integrated web and desktop workflow.",
    ...
    impact: [
      { value: "30+", label: "Companies registered" },
  ...
  },
  {
    ...
    role: "Software Engineer at YoForex",
    description:
      "Built and delivered Blog Forge for YoForex's digital marketing team, creating a full-stack content operations platform that turns owned keywords into grounded, publish-ready articles and improved overall traffic by 30%.",
